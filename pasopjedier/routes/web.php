...
Route::middleware(['auth'])->group(function(){
    ...
    Route::patch('/profile/update', [App\Http\Controllers\UserController::class, 'update_profile']);
    ...
    Route::get('/accept/delete/{id}',[App\Http\Controllers\AcceptController::class, 'destroy_accept']);
    ...
    Route::get('/profile/edit', [App\Http\Controllers\UserController::class, 'edit_profile']);
    Route::get('/profile/{id}', [App\Http\Controllers\UserController::class, 'show_profile']);
    ...
    Route::get('/profile', [App\Http\Controllers\UserController::class, 'index_profile']);
